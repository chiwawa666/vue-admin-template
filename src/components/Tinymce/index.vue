...
// 2024-03-22 chiwawa
// 由于国内各站点tinymce资源缺少语言包，而且tinymce官方提供语言包cdn，但是时常会timeout,，所以需要自己手动引入语言包
// /funeral/tinymce/zh_CN.js   服务器访问路径

const tinymceCDN =
  // "https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.9.2/tinymce.min.js";
  "https://lf26-cdn-tos.bytecdntp.com/cdn/expire-0-M/tinymce/4.9.2/tinymce.min.js";
  ...
  methods: {
    ...
    initTinymce() {
      ...
      window.tinymce.init({
        ...
        language_url: "/funeral/tinymce/zh_CN.js", //导入语言文件
        language: "zh_CN",
        height: this.height,
