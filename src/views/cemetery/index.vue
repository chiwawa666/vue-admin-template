<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="建成年份" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.year }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="公墓负责人" align="center" width="auto">
        <template slot-scope="{ row }">
          <span>{{ row.incharge }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="{ row }">
          ...
          <el-button type="primary" size="mini">
            <router-link :to="'/cemetery/info/' + row.id"> 查看 </router-link>
          </el-button>

          <el-button type="primary" size="mini">
            <router-link to="/cemetery/create"> 使用情况 </router-link>
          </el-button>
