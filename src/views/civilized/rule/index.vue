<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link to="/civilized/rule/create/">
    ...
    >
      ...
      <el-table-column label="颁布日期" align="center" width="auto">
        <template slot-scope="{ row }">
      ...
      >
        <template slot-scope="{ row, $index }">
          ...
          <el-button type="primary" size="mini">
            <router-link :to="'/civilized/rule/edit/' + row.id">
              编辑
            </router-link>
          </el-button>
...
<script>
import { getRule } from "@/api/civilized";
