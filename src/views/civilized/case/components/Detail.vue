  ...
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120px">
      <!-- <el-form-item label="政策法规名称">
        <el-input :span="11" v-model="form.name" />
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" size="mini">
          <router-link to="/civilized/case"> 提交 </router-link>
        </el-button>
        <el-button type="primary" size="mini">
          <router-link to="/civilized/case"> 返回 </router-link>
        </el-button>
      </el-form-item>
    </el-form>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      content2: `<p>　近日，记者在安徽省宿州市埇桥区调查发现，当地多座村级公益性公墓长期售卖高价墓、家族墓和活人墓等，甚至涉嫌违法用地屡禁不止，超范围销售给本地以外的人。有的一座墓穴售价高达32.8万元，周边村民直言&ldquo;死不起&rdquo;&ldquo;葬不起&rdquo;。对此，当地政府主管部门坦承&ldquo;也管了&rdquo;，但就是&ldquo;管不住&rdquo;。</p>\n<p style=\"text-align: center;\">　　<strong>打着&ldquo;公益&rdquo;的幌子</strong></p>\n<p style=\"text-align: center;\"><strong>　　干着&ldquo;牟利&rdquo;的勾当</strong></p>\n<p style=\"text-align: center;\">　　涉嫌5项违法违规！</p>\n<p class=\"f_center\" style=\"text-align: center;\"><img src=\"http://dingyue.ws.126.net/2021/0405/67340e30g00qr3ccw00s0c000a0005nc.gif\" /></p>\n<p style=\"text-align: center;\">　　<strong>问题一：销售&ldquo;天价墓&rdquo;</strong></p>\n<p class=\"f_center\"><img style=\"display: block; margin-left: auto; margin-right: auto;\" src=\"http://dingyue.ws.126.net/2021/0405/e481aed0g00qr3ccw036xc000a0005nc.gif\" /></p>\n<p>　　夹沟镇夏刘寨公墓是一家村级公益性公墓，由埇桥区民政局于2009年批复建设，现已安葬墓穴2563座。<strong>目前，其在售墓地品类多达17种，单座墓地最大占地面积超过20平方米，单价从每座8800元到328000元不等。</strong></p>`,
      info: [
        {
          label: "殡葬管理条例",
          date: "1997-07-21",
  ...
  methods: {
    ...
    fetchData(id) {
      ...
      // this.content = this.list[id - 1];
      // this.form.name = this.info[id - 1].label;
      // this.form.date = this.info[id - 1].date;
    },
  },
};
</script>
