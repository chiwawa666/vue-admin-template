<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link to="/civilized/case/create/">
    ...
    >
      ...
      <el-table-column label="处置时间" align="center" width="auto">
        <template slot-scope="{ row }">
      ...
      <el-table-column label="处置结果" align="center" width="auto">
        <template slot-scope="{ row }">
          <span class="link-type">{{ row.result }}</span>
        </template>
      </el-table-column>
      <el-table-column
        label="操作"
      ...
      >
        <template slot-scope="{ row, $index }">
          ...
          <el-button size="mini" type="primary">
            <router-link :to="'/civilized/case/edit/' + row.id">
              编辑
            </router-link>
          </el-button>
...
<script>
import { illegalList } from "@/api/funeralSupervision";
